...
// import { Search, UserPlus, IndianRupee, Loader2, Edit, CalendarIcon, Filter, Download } from "lucide-react";
...
//       fetchMembers();
//       fetchPlans();
//       // Optional: auto-check expiry on load
...
//   // Optional: Auto-expiry check & renewal (can be called on load or via cron)
...
//                 pendingAmount: Math.max(0, m.pendingAmount - payAmount),
//                 status: m.pendingAmount - payAmount <= 0 ? "ACTIVE" : m.status,
//                 expiryDate:
//                   m.pendingAmount - payAmount <= 0
//                     ? addDays(new Date(), selectedMemberForPay.plan.duration).toISOString()
//                     : m.expiryDate,
//               }
//             : m
//         )
...
//       // Optimistic update with correct plan name
...
//                         <FormControl>
//                           <Input
//                             type="number" disabled className="bg-muted" 
//                             min={0}
//                             {...field}
